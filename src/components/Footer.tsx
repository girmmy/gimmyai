        ...
        <div className="text-center">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto">
              ...
              science, literature, and more. Upload images of your problems for
          ...
          <div className="flex justify-center space-x-4 mb-8">
            ...
            <a
              ...
              className="w-10 h-10 bg-slate-700 hover:bg-green-600 rounded-lg flex items-center justify-center transition-colors"
              title="Email"
            >
              <svg
                className="w-5 h-5 text-white"
          ...
          <div className="border-t border-slate-700 pt-8">
            <p className="text-slate-400">
              © 2024 GimmyAI. All rights reserved. Built with ❤️ for students.
            </p>
          </div>
        </div>
      </div>
